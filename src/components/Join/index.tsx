  ...
  return (
    <>
      ...
      <Dialog open={open} TransitionComponent={Transition} keepMounted onClose={handleClose}>
        ...
        <DialogActions>
          <Button disabled size={buttonSize} color="success" variant='outlined' onClick={handleLogin}>Register</Button>
          <Button size={buttonSize} color="success" variant='outlined' onClick={handleLogin}>ok</Button>
        </DialogActions>
      </Dialog>
    </>
  );
