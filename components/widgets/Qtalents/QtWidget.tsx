...
const QtWidget = () => {
  ...
  const handleScroll = (index: any) => (event: any) => {
    ...
    const visibleImageIndex = Math.ceil(
        ...
        <Paper variant="outlined" sx={{ borderColor: "gray", padding: 0 }}>
          <Box textAlign="left">
            <Box>
              ...
              <Card
                elevation={4}
                sx={{ backgroundColor: "transparent", maxHeight: 560 }}
              >
                <Box
                  p={1}
                  justifyContent={"space-between"}
                ...
                >
                  ...
                  <Typography
                    ...
                    color={"primary.main"}
                  >
                    Designed and developed new features to meet user
                    requirements and needs. Researched modern technologies and
                    innovative solutions to optimize development processes.
                  </Typography>
                  ...
                  <Typography
                    ...
                    color={"primary.main"}
                  >
                    Refactored existing code to improve readability,
                  ...
                  <Typography
                    ...
                    color={"primary.main"}
                  >
                    Identified, analyzed, and resolved code errors to ensure
                    system stability and smooth operation.
                  </Typography>

                  <Typography variant="subtitle1">
                    Implementation of New UI Components:
                  </Typography>
                  <Typography
                    variant="body2"
                    gutterBottom={true}
                    color={"primary.main"}
                  >
                    Developed and integrated a new UI component that
                    significantly enhanced user experience. Conducted testing
                    and optimization of the new UI component.
                  </Typography>
                  ...
                  <Typography
                    ...
                    color={"primary.main"}
                  >
                    Programming languages: JavaScript Frameworks: Next.js
                    Libraries: React Tools: Git
                  </Typography>
                </Box>
              </Card>
              <Card>
                      ...
                      >
                        <Box p={1} justifyContent={"space-between"}>
                          <Typography variant="body1">
                            Apr 15, 2024 Finished Omex Build Project: [ feb 2024
                            - apr 2024 ]
                          </Typography>
                          <Typography variant="body2">
                            Functional Requirements: contact form, customer
                            review, scanning qr code notification to mail{" "}
                          </Typography>
                        </Box>
